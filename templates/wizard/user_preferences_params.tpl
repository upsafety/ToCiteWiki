{* $Id: user_preferences_params.tpl 50841 2014-04-20 22:16:25Z jyhem $ *}
		...
		<tr>
			...
			<td>
				...
				{if $warning_site_timezone_set eq 'y'}
					<br/><strong>{tr}Warning:{/tr}</strong> <i>{tr}Site timezone is enforced and overrides user preferences{/tr}</i>
				{/if}
			</td>
		</tr>
		<tr>
