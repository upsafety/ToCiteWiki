{* $Id: mod-user_bookmarks.tpl 47507 2013-09-16 13:52:16Z chibaguy $ *}
...
<ul>
    ...
    <input style="font-size: 9px;" type="submit" class="btn btn-default" name="bookmark_create_folder" value="{tr}New Folder{/tr}" />
    </form>
    {/tikimodule}
{/if}
