{* $Id: tiki-accounting_export.tpl 47507 2013-09-16 13:52:16Z chibaguy $ *}
 ...
 <form action="tiki-accounting_export.php" method="post">
	...
	<fieldset>
		<legend>{tr}Export CSV settings{/tr}</legend>
			...
			<input type="submit" class="btn btn-default" name="submit" value="{tr}Export as CSV{/tr}" onclick="this.form.target='_blank';return true;">
